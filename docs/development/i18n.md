...
myst:
  html_meta:
    "description": "Rules and guidelines for internationalization (i18n) in Plone Aurora."
    "property=og:description": "Rules and guidelines for internationalization (i18n) in Plone Aurora."
    "property=og:title": "internationalization (i18n)"
    "keywords": "Plone Aurora, Plone, frontend, React, configuration, i18n"
---

# Internationalization (i18n)

Plone Aurora uses [react-i18next](https://react.i18next.com/) for {term}`internationalization` (i18n), providing a modern approach to managing translations in React applications.
...
Using `catalog:` ensures that your add-on uses the same version of `react-i18next` as the Plone Aurora core.
...
Currently, Plone Aurora only supports the `common` namespace.
