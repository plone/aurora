...
describe('middleware', () => {
      ...
      await getAPIResourceWithAuth(
        {
          ...
          params,
          context,
          pattern: '/image.png/@@images/image',
          url: new URL(request.url),
        },
        nextMock,
      );
      ...
      await getAPIResourceWithAuth(
        {
          ...
          params,
          context,
          pattern: '/file.txt/@@download/file',
          url: new URL(request.url),
        },
        nextMock,
      );
  ...
  describe('linkMiddleware', () => {
    const makeArgs = (context: RouterContextProvider) => ({
      ...
      params: {},
      pattern: '/link',
      url: new URL('http://example.com/link'),
    });
