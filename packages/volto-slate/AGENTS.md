...
- It will be **superseded by `@plone/plate`** in the Plone Aurora context and will eventually be removed from this repo.

## Important Notice

> **Do not make significant changes to this package.**
>
> This package is reference code. The active Plone Aurora block editor is `@plone/plate`. If you need to fix a volto-slate issue, contribute upstream to the canonical Volto repository.
