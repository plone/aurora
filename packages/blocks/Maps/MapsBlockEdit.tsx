...
const MapsBlockEdit = (props: BlockEditProps) => {
  ...
  const onChangeUrl = ({ target }: ChangeEvent<HTMLInputElement>) => {
    setUrl(target.value);
  };
      ...
      {data.url ? (
        ...
        <div>
          ...
          >
            ...
            <div
              className={`mb-6 flex w-95 max-w-full items-center bg-white px-4 py-3 shadow-sm`}
            >
              {' '}
              <input
